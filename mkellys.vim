...
if has("gui_running")
	...
	if &t_Co == 256
		...
		hi Folded 		ctermfg=239	ctermbg=none	cterm=none
		hi MatchParen	ctermfg=184	ctermbg=none	cterm=bold,underline
		hi ModeMsg		ctermfg=254	ctermbg=none	cterm=bold
		...
		hi PreProc		ctermfg=184	ctermbg=none	cterm=none 
