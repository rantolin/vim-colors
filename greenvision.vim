...
"hi Comment		guifg=#008220 guibg=#000000 gui=none ctermfg=034             cterm=none
hi Comment		guifg=#008220 guibg=#000000 gui=none ctermfg=DarkGreen             cterm=none
"hi Comment		guifg=#008220 guibg=#000000 gui=none ctermfg=034 ctermbg=000 cterm=none
hi Constant		guifg=#1fc700 guibg=#001c00 gui=none ctermfg=041             cterm=none
...
hi Normal		guifg=#00a900 guibg=#000000 gui=none ctermfg=White           cterm=bold
hi Pmenu		guifg=#00bf00 guibg=#000a00 gui=none ctermfg=002             cterm=none
...
hi Question		guifg=#009f00 guibg=#000000 gui=none ctermfg=040             cterm=none
...
hi Statement		guifg=#2fc626 guibg=#000000 gui=none ctermfg=010             cterm=none
...
hi TabLine		guifg=#00f400 guibg=#000a00 gui=none ctermfg=040             cterm=none
hi TabLineFill		guifg=#00ea00 guibg=#000000 gui=none ctermfg=000             cterm=none
hi TabLineSel		guifg=#00f000 guibg=#002a00 gui=none ctermfg=046 ctermbg=022 cterm=bold
hi Title		guifg=#09ab00 guibg=#000000 gui=bold ctermfg=010             cterm=bold
hi Todo			guifg=#000000 guibg=#00ed00 gui=none ctermfg=000 ctermbg=002 cterm=none
hi Type			guifg=#1fb631 guibg=#000000 gui=none ctermfg=046             cterm=none
